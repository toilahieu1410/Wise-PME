$("#list-1").on('change', function() {
  ...
  if (selVal == "time-1") {
    $.ajax({
      url: 'http://10.10.15.20:1880/frequency87-6h',
    ...
    $.ajax({
      url: 'http://10.10.15.20:1880/frequency87-24h',
      complete: function(json) {
        data = JSON.parse(json.responseText);
    ...
    $.ajax({
      url: 'http://10.10.15.20:1880/frequency87-7d',
      complete: function(json) {
        data = JSON.parse(json.responseText);
    ...
    $.ajax({
      url: 'http://10.10.15.20:1880/frequency87-30d',
      complete: function(json) {
        data = JSON.parse(json.responseText);
