$("#list-1").on('change', function() {
  ...
  if (selVal == "time-1") {
    $.ajax({
      url: 'http://10.10.15.20:1880/voltages972-6h',
    ...
    $.ajax({
      url: 'http://10.10.15.20:1880/voltages972-24h',
      complete: function(json) {
        data = JSON.parse(json.responseText);
    ...
    $.ajax({
      url: 'http://10.10.15.20:1880/voltages972-7d',
      complete: function(json) {
        data = JSON.parse(json.responseText);
    ...
    $.ajax({
      url: 'http://10.10.15.20:1880/voltages972-30d',
      complete: function(json) {
        data = JSON.parse(json.responseText);
