$("#list-1").on('change', function() {
  ...
  if (selVal == "time-1") {
    $.ajax({
      url: 'http://10.10.15.20:1880/voltages972-6h20s',
    ...
    $.ajax({
      url: 'http://10.10.15.20:1880/voltages972-24h20s',
      complete: function(json) {
        data = JSON.parse(json.responseText);
    ...
    $.ajax({
      url: 'http://10.10.15.20:1880/voltages972-7d20s',
      complete: function(json) {
        data = JSON.parse(json.responseText);
    ...
    $.ajax({
      url: 'http://10.10.15.20:1880/voltages972-30d20s',
      complete: function(json) {
        data = JSON.parse(json.responseText);
