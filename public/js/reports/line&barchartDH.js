$(function() {
    ...
    $.ajax({
      url: 'http://10.10.15.20:1880/voltagesdh-max',
  ...
  $(function() {
    ...
    $.ajax({
      url: 'http://10.10.15.20:1880/currentsdh-max',
      complete: function(json) {
        data = JSON.parse(json.responseText);
  ...
  $(function() {
    $.ajax({
      url: 'http://10.10.15.20:1880/THD-currentAdh-max',
      complete: function(json) {
        data = JSON.parse(json.responseText);
...
$(function() {
    $.ajax({
      url: 'http://10.10.15.20:1880/thd1-currentAdh-max',
      complete: function(json) {
        data = JSON.parse(json.responseText);
