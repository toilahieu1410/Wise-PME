$(function() {
    ...
    $.ajax({
      url: 'http://10.10.15.20:1880/voltages972-max',
  ...
  $(function() {
    ...
    $.ajax({
      url: 'http://10.10.15.20:1880/currents972-max',
      complete: function(json) {
        data = JSON.parse(json.responseText);
  ...
  $(function() {
    ...
    $.ajax({
      url: 'http://10.10.15.20:1880/THD-currentA972-max',
      complete: function(json) {
        data = JSON.parse(json.responseText);
...
$(function() {
    $.ajax({
      url: 'http://10.10.15.20:1880/thd1-currentA972-max',
      complete: function(json) {
        data = JSON.parse(json.responseText);
